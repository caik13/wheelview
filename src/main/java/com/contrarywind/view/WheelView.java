...
import com.contrarywind.util.ScreenUtil;
...
public class WheelView extends View {
    ...
    private static final int SHAPE_MIDDLE = 2;
    private static final int SHAPE_RIGHT = 3;
    private static final int SHAPE_SINGLE = 4;
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            shape = a.getInt(R.styleable.pickerview_wheelview_back_shape, -1);
            a.recycle();//回收内存
        }
    ...
    private void reMeasure() {//重新测量
        ...
        firstLineY = (measuredHeight - itemHeight) / 2.0F + 20;
        secondLineY = (measuredHeight + itemHeight) / 2.0F + 20;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (dividerType == DividerType.WRAP) {//横线长度仅包裹内容
            ...
            if (shape == SHAPE_LEFT) {
                canvas.drawRoundRect(ScreenUtil.dp2px(context, 10), firstLineY, measuredWidth, secondLineY, ScreenUtil.dp2px(context, 10), ScreenUtil.dp2px(context, 10), paintIndicator);
                canvas.drawRect(ScreenUtil.dp2px(context, 20), firstLineY, measuredWidth, secondLineY, paintIndicator);
            } else if (shape == SHAPE_RIGHT) {
                canvas.drawRoundRect(ScreenUtil.dp2px(context, 20), firstLineY, measuredWidth - ScreenUtil.dp2px(context, 10), secondLineY, ScreenUtil.dp2px(context, 10), ScreenUtil.dp2px(context, 10), paintIndicator);
                canvas.drawRect(0.0F, firstLineY, measuredWidth - ScreenUtil.dp2px(context, 20), secondLineY, paintIndicator);
            } else if (shape == SHAPE_MIDDLE) {
                canvas.drawRect(0.0F, firstLineY, measuredWidth, secondLineY, paintIndicator);
            } else if (shape == SHAPE_SINGLE) {
                // 单个wheel的情况，绘制四个圆角
                canvas.drawRoundRect(ScreenUtil.dp2px(context, 20), firstLineY, measuredWidth-ScreenUtil.dp2px(context,20), secondLineY,ScreenUtil.dp2px(context, 10),ScreenUtil.dp2px(context, 10), paintIndicator);
            } else {
